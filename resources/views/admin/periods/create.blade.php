...
@section('content')
<h1 class="text-3xl font-bold text-slate-800 mb-6">Tambah Periode</h1>
<div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 max-w-2xl">
    <form action="{{ route('admin.periods.store') }}" method="POST">
        ...
        <div class="mb-6 flex items-center">
            <input type="checkbox" name="is_active" value="1" id="is_active" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
