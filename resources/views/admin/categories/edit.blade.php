...
<div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 max-w-2xl">
    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ $category->name }}" class="w-full p-2 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-3">
                <input type="color" name="color" value="{{ $category->color }}" class="h-10 w-10 border border-slate-300 rounded cursor-pointer" required>
